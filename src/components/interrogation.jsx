export default function Interrogation() {
    return (
        <div className="relative group">
            ...
            <div className="hidden group-hover:flex absolute  opacity-0  group-hover:opacity-100 py-2 p-7 bg-black text-white bg-opacity-95   rounded-md shadow-2xl transition duration-500 ease-in-out w-[320px] roboto-regular text-center text-lg -right-[40%]   md:-left-28 transform md:-translate-x-28  lg:left-1/2  lg:-translate-x-1/2 z-20 top-full">
